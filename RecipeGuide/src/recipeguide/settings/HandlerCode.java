...
public final class HandlerCode {
	...
	public static final String TOOLBAR_FILE_NEW = "toolbarFileNew";
	public static final String TOOLBAR_FILE_EDIT = "toolbarFileEdit";
	public static final String TOOLBAR_FILE_OPEN = "toolbarFileOpen";
