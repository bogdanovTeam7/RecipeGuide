	...
	public RecipeTableData() {
		super(new LinkedHashMap<>() {
			...
			private static final long serialVersionUID = 1L;
			{
				...
				put(Text.get("ingredientsWihQuantity"), Style.ICON_TABLE_RECIPE_INGREDIENTS_WITH_QUANTITY);
				put(Text.get("ration"), Style.ICON_TABLE_RECIPE_RATION);
				put(Text.get("description"), Style.ICON_TABLE_RECIPE_DESCRIPTION);
				put(Text.get("preparingTimeInSeconds"), Style.ICON_TABLE_PREPARING_TIME);
